...
for (let boton of botones){
    switch(boton.id){
        ...
        case "play": boton.addEventListener("click", iniciar); break;
        case "parar": boton.addEventListener("click", parar); break;
        case "rapido": boton.addEventListener("click", acelerar); break;
        case "lento": boton.addEventListener("click", ralentizar); break;
        case "api": boton.addEventListener("click", recibirDatos); break;
    }
}